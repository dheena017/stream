...
class TestDocumentProcessor(unittest.TestCase):
    def test_extract_text_from_pdf(self):
        ...
        # Setup metadata
        mock_reader.metadata = {'/Title': 'Test PDF', '/Author': 'Tester', '/CreationDate': 'Today'}
        ...
        with patch.dict(sys.modules, {'PyPDF2': mock_pypdf2}):
            # Mock open
            with patch('builtins.open', unittest.mock.mock_open(read_data=b'fake pdf data')):
        ...
        self.assertEqual(text, expected_part1 + expected_part2 + expected_part3 + expected_part4)
