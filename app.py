...
with st.sidebar:
    ...
    with st.expander(f"🔑 API Keys ({configured_keys}/6 configured)", expanded=False):
        ...
        show_keys = st.checkbox(
            "👁️ Show API Keys", 
            value=False, 
            help="⚠️ Only enable when needed. Keep your API keys private! Never share them."
        )
        if show_keys:
        ...
        google_api_key = st.text_input(
            ...
            help="Paste your Google Gemini API key here. Get it from https://makersuite.google.com/app/apikey",
