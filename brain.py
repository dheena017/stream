...
def _cached_search_internet(query: str, num_results: int = 5) -> List[Dict[str, str]]:
    """Cached execution of DuckDuckGo search"""
    try:
...
class AIBrain:
    ...
    def search_internet(self, query: str, num_results: int = 5) -> List[Dict[str, str]]:
        """Search the internet using DuckDuckGo (Cached)"""
        return _cached_search_internet(query, num_results)
