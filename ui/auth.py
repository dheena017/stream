...
def load_user_credentials() -> Dict[str, Dict[str, str]]:
    ...
    # If environment variables are not set, generate random passwords to prevent unauthorized access
    admin_pw = os.getenv("ADMIN_PASSWORD") or secrets.token_hex(16)
    user_pw = os.getenv("USER_PASSWORD") or secrets.token_hex(16)
